---
name: oanastack
description: oanastack 协作规则与常见工作流（调研、开 feature、UI 设计、修 bug、验证、review、盯 PR/CI、清理 worktree、按门槛复盘）
---
...
- UI 设计：`playbooks/uidesign.md`（foundation：`references/ui-foundation.md`）
